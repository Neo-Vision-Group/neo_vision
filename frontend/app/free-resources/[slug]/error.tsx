...
export default function Error({
  ...
  useEffect(() => {
    console.error("[free-resources/error] Route render failed.", error);
  }, [error]);
  ...
  return (
    <main className="flex min-h-[60vh] flex-col items-center justify-center gap-4 px-6 py-16 text-center">
      ...
      <h1 className="max-w-[16ch] text-64xl font-medium text-foreground">This page failed to render.</h1>
