...
export function ResourceRequestNotification({
  ...
  const heading = forClient
    ? (content?.title ?? "Your resource is on its way")
    : "New resource request";
  const introFallback = "Thanks for requesting a resource from Neo Vision. We've received your details and the resource will be sent to your inbox shortly.";
  const footerFallback = "Need help or have questions? Just reply to this email and we'll get back to you.";
  const internalFooter = "This email was generated by the resource request form on neovision.dev. Reply directly to follow up with the requester.";
          ...
          <div style={{ padding: "32px 24px 28px" }}>
            ...
            >
              {forClient ? (
                ...
                <p style={{ margin: 0 }}>A user has requested a free resource from the website. Details are below.</p>
              )}
            </div>
