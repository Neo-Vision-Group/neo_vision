  ...
  return (
    ...
    >
      <div className="flex flex-col gap-8 border-t border-white/20 bg-linear-to-b from-background to-surface/60 px-6 py-16 md:px-6 md:py-24 lg:px-8 xl:px-12">
        <h2 className="text-4xl leading-12 tracking-[-0.3px] text-foreground md:text-5xl md:leading-14.5 md:tracking-[-0.4px] lg:text-[56px] lg:leading-16 xl:text-[72px] xl:leading-20 2xl:text-[88px] 2xl:leading-[92px]">
          {heading.regular}{" "}
