    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 38 24" fill="none" className={className}>
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                <path opacity="0.5" fill-rule="evenodd" clip-rule="evenodd" d="M22 12.0004C22 17.5234 17.523 22.0004 12 22.0004C10.8691 22.0015 9.74615 21.8108 8.67901 21.4364C8.22985 20.3466 7.99915 19.1791 8.00001 18.0004C7.99726 15.8666 8.7553 13.8016 10.138 12.1764C10.7352 13.0472 11.5355 13.7595 12.4698 14.2515C13.404 14.7436 14.4441 15.0006 15.5 15.0004C16.6201 15.0006 17.7212 14.7113 18.6966 14.1606C19.672 13.6099 20.4885 12.8165 21.067 11.8574C21.307 11.4614 22 11.5374 22 12.0004Z" fill="#FF4100"/>
                <path d="M2 12C2 16.359 4.789 20.066 8.679 21.435C8.22997 20.3455 7.99927 19.1784 8 18C8 15.779 8.805 13.746 10.138 12.176C9.39462 11.0944 8.99773 9.81239 9 8.5C8.99983 7.37991 9.28911 6.27877 9.83979 5.30339C10.3905 4.32801 11.1839 3.51149 12.143 2.933C12.54 2.693 12.463 2 12 2C6.477 2 2 6.477 2 12Z" fill="#FF4100"/>
            </svg>
        </svg>
    )
}