...
export function Footer({ columns, title, email, logo, location, copyright }: NavClientProps) {
  return (
    <footer className="relative w-full overflow-hidden border-t border-border bg-background">
      <div className="relative flex flex-col md:flex-row md:items-stretch md:h-[584px]">
        ...
        <div
          aria-hidden="true"
          className="pointer-events-none absolute bottom-0 left-[calc(50%+200px)] z-0 w-[900px] max-w-none -translate-x-1/2 translate-y-[34%] select-none md:left-[calc(50%+250px)] md:w-[1050px] lg:left-[calc(50%+313px)] lg:w-[1197px]"
        >
          <Image
            src=""
            alt=""
            ...
            style={{
              filter: "brightness(0.55) hue-rotate(-10deg) saturate(1.3)",
              opacity: 0.85,
            }}
          />
        </div>
